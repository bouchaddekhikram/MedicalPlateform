...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="C:\Users\bouch\Downloads\web_project\web_project\css\homeStyle.css">
...
<header>
    ...
    <main>
        <section class="left-sec">
            <h2> This platform will help you</h2>
            <h1> to organise patients & oppointments </h1>
            <p>We are here for your service 24/7. Any help just call us.</p>
            <!--            <button>-->
            <!--                Make an appointment-->
            <!--            </button>-->
        </section>
